...
async def start(client, message):
    ...
    if data.startswith("all"):
        ...
        for file in files:
            ...
            await client.send_cached_media(
                ...
                reply_markup=InlineKeyboardMarkup( [ [ InlineKeyboardButton('⚔️ DaddyCooL ⚔️', url=f"https://t.me/Daddycool_Kingdom") ] ] ),
            )
        return
    ...
    await client.send_cached_media(
        ...
        caption=f_caption,
        protect_content=True if pre == 'filep' else False,
        reply_markup=InlineKeyboardMarkup( [ [ InlineKeyboardButton('⚔️ DaddyCooL ⚔️', url="https://t.me/DaddyCooL_KingDom") ] ] ),
    )
